...
namespace csgbe.perifericos{
	...
	/// <summary>Cartucho MBC3</summary>
	public class CartuchoMBC3 : Cartucho{

		/// <summary>Definicion del tipo de cartucho</summary>
		private static string tipoCartucho = "MBC3";
		...
		public CartuchoMBC3(string nombreFichero) : base(nombreFichero){}
		...
		public override void escribir(int valor, int direccion){
			...
			else if (direccion < 0x4000) _romPage = valor & 0x7F; 
			// 0x4000-0x6000: Seleccion de banco de RAM
			else if (direccion < 0x6000) _ramPage = valor & 0x03;
			// RAM
