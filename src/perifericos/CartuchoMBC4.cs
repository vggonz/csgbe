...
namespace csgbe.perifericos{
	...
	/// <summary>Cartucho MBC4</summary>
	public class CartuchoMBC4 : Cartucho{

		/// <summary>Definicion del tipo de cartucho</summary>
		private static string tipoCartucho = "MBC4";

		/// <summary>Constructor</summary>
		/// <param name="nombreFichero">Ruta al fichero del cartucho</param>
		public CartuchoMBC4(string nombreFichero) : base(nombreFichero){}
		...
		/// <returns>Byte posicionado en la direccion</returns>
                public override byte leer(int direccion){ return 0; }
